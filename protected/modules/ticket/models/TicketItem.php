 ...
 *
 * The followings are the available columns in table 'ticket_item':
 * @property integer $id
...
class TicketItem extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('tickets_id, items_id', 'required'),
			array('tickets_id, items_id', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, tickets_id, items_id', 'safe', 'on'=>'search'),
		);
	}
